...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showOtherRoleLoginForm()
    {
    ...
    public function loginOtherRole(Request $request)
    {
        $this->validateLogin($request);
        ...
        if ($this->attemptLogin($request, 'other_role')) {
            return $this->sendLoginResponse($request, '/other_role/dashboard');
        }
